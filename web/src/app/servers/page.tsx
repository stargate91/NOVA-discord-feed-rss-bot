...
export default function ServersPage() {
  ...
  const sortedGuilds = [...guilds].sort((a, b) => ((b.hasBot || b.bot_in_guild) ? 1 : 0) - ((a.hasBot || a.bot_in_guild) ? 1 : 0));
        ...
        <div className={styles.guildList}>
          {sortedGuilds.map((guild, i) => {
            ...
            return (
              <div
                key={guild.id}
                className={`${styles.guildCard} ${hasBot ? '' : styles.guildCardNoBot} ${guild.isPremium ? styles.premiumBorder : ''}`}
              ...
              >
                ...
                <div className={styles.guildIconWrapper}>
                  ...
                  {hasBot && <div className={styles.botPulse}></div>}
                </div>
                ...
                <div className={styles.guildInfo}>
                  ...
                  <div className={styles.badgeContainer}>
                    ...
                    {!hasBot && <span className={`${styles.badge} ${styles.inviteBadge}`}>Not installed</span>}
                  </div>
                </div>
