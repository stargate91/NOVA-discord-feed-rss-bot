...
import { X, Rss, Zap, Check, AlertCircle, ChevronRight, ChevronLeft, RefreshCw, Shield } from "lucide-react";
...
const platforms: BulkPlatform[] = [
  { id: 'youtube', name: 'YouTube', icon: <img src="/brands/youtube.png" alt="YT" style={{ width: '24px', height: '24px' }} />, color: '#ff0000', emoji: '/brands/youtube.png', placeholder: 'https://youtube.com/@handle\n@username\nUCID', hint: 'Links, @handles or UCIDs' },
  { id: 'stream', name: 'Twitch', icon: <img src="/brands/twitch.png" alt="Twitch" style={{ width: '24px', height: '24px' }} />, color: '#9146ff', emoji: '/brands/twitch.png', placeholder: 'twitch_user\nhttps://twitch.tv/user', hint: 'Usernames or Links' },
  { id: 'kick', name: 'Kick', icon: <img src="/brands/kick.png" alt="Kick" style={{ width: '24px', height: '24px' }} />, color: '#53fc18', emoji: '/brands/kick.png', placeholder: 'kick_user\nhttps://kick.com/user', hint: 'Usernames or Links' },
  { id: 'rss', name: 'RSS Feed', icon: <Rss />, color: '#ee802f', emoji: '/brands/rss.png', placeholder: 'https://site.com/feed.xml\nhttps://blog.com/rss', hint: 'Full RSS/Atom URLs' },
  { id: 'github', name: 'GitHub', icon: <img src="/brands/github.png" alt="GH" style={{ width: '24px', height: '24px' }} />, color: '#fafafa', emoji: '/brands/github.png', placeholder: 'owner/repo\nhttps://github.com/owner/repo', hint: '"owner/repo" or Links' },
  { id: 'steam_news', name: 'Steam News', icon: <img src="/brands/steam.png" alt="Steam" style={{ width: '24px', height: '24px' }} />, color: '#66c0f4', emoji: '/brands/steam.png', placeholder: '730\nhttps://store.steampowered.com/app/730', hint: 'App IDs or Store URLs' },
];
...
export default function BulkAddModal({ 
  ...
  const [selectedPlatform, setSelectedPlatform] = useState<BulkPlatform | null>(null);
          ...
          {guildLoading ? (
            ...
            <div className="premium-lock">
              <div className="lock-content">
                ...
                <a href={`/dashboard/${guildId}/billing`} className="upgrade-btn">Upgrade to Professional</a>
              </div>
            </div>
          ) : (
            <>
                ...
                <div className="ui-platform-grid" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', padding: '2rem' }}>
                  {platforms.map(p => (
                    <div
                      ...
                      style={{ "--platform-color": p.color, flexDirection: 'column', textAlign: 'center', padding: '2rem 1rem' } as React.CSSProperties}
                    >
